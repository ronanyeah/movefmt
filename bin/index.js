...
program.option("-v, --verbose", "enable verbose logging").option("-f, --force", "don't ignore sui build folder").argument("<path>", "target file|directory path").parse(process.argv);
